  ...
  template: `
    <aside class="w-64 bg-white border-r border-border flex flex-col h-screen fixed top-0 left-0">
      ...
      <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <!-- new resource links -->
        <a routerLink="/admin/offers" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
            <lucide-icon [name]="Users" [size]="18"></lucide-icon>
            <span class="font-medium">Internship Offers</span>
          </div>
          <lucide-icon [name]="ChevronRight" [size]="14" class="opacity-0 group-hover:opacity-100 transition-opacity"></lucide-icon>
        </a>
        <a routerLink="/admin/internships" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
            <lucide-icon [name]="GraduationCap" [size]="18"></lucide-icon>
        ...
        <a routerLink="/admin/certification-rules" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
            <lucide-icon [name]="Settings" [size]="18"></lucide-icon>
            <span class="font-medium">Certification Rules</span>
          </div>
          <lucide-icon [name]="ChevronRight" [size]="14" class="opacity-0 group-hover:opacity-100 transition-opacity"></lucide-icon>
        </a>
        <a routerLink="/admin/certificates" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
            <lucide-icon [name]="GraduationCap" [size]="18"></lucide-icon>
        ...
        <a routerLink="/admin/applications" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
            <lucide-icon [name]="Users" [size]="18"></lucide-icon>
        ...
        <a routerLink="/admin/evaluations" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
            <lucide-icon [name]="Users" [size]="18"></lucide-icon>
        ...
        <a routerLink="/admin/documents" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">
        ...
        <a routerLink="/verify" routerLinkActive="bg-teal-50 text-teal-600" class="flex items-center justify-between p-3 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all duration-300 group">
          <div class="flex items-center gap-3">

...
// new admin pages
import { AdminOffersComponent } from './pages/admin/admin-offers.component';
import { AdminInternshipsComponent } from './pages/admin/admin-internships.component';
import { AdminCertificationRulesComponent } from './pages/admin/admin-certification-rules.component';
import { AdminCertificatesComponent } from './pages/admin/admin-certificates.component';
import { AdminApplicationsComponent } from './pages/admin/admin-applications.component';
import { AdminEvaluationsComponent } from './pages/admin/admin-evaluations.component';
...
export const routes: Routes = [
    ...
    // Admin Routes
    {
        ...
        children: [
            ...
            { path: 'certification-rules', component: AdminCertificationRulesComponent },

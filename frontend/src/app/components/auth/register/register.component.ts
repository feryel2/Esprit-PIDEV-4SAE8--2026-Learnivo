  ...
  constructor(
    ...
    this.registerForm.get('role')?.valueChanges.subscribe((role) => {
      if (role === Role.SOCIETY_AGENT) {
        this.registerForm.get('societyName')?.setValidators([Validators.required]);
        this.registerForm.get('societyEmail')?.setValidators([Validators.required, Validators.email]);
      } else {

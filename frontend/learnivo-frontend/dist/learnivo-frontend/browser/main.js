...
var routes = [
  ...
  {
    path: "",
    loadComponent: () => import("./chunk-PA6NF32N.js").then((m) => m.LayoutComponent),
    canActivate: [authGuard],
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-RAYFTDSR.js").then((m) => m.DashboardComponent) },
      { path: "internships", loadComponent: () => import("./chunk-LQPGHM74.js").then((m) => m.InternshipsComponent) },
      { path: "applications", loadComponent: () => import("./chunk-IDLWATZ7.js").then((m) => m.ApplicationsComponent) },
      { path: "certificates", loadComponent: () => import("./chunk-ZXAH5D3E.js").then((m) => m.CertificatesComponent) },
      { path: "events", loadComponent: () => import("./chunk-KCSXFMN2.js").then((m) => m.EventsComponent) }
    ]
  },
  { path: "verify", loadComponent: () => import("./chunk-Q6AVI5XE.js").then((m) => m.VerifyComponent) },
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 1, consts: [["class", "loading-bar", 4, "ngIf"], [1, "loading-bar"], ["mode", "indeterminate", "color", "accent"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, AppComponent_div_0_Template, 2, 0, "div", 0);
        \u0275\u0275element(1, "router-outlet");
      }
      if (rf & 2) {
        \u0275\u0275property("ngIf", ctx.loader.loading());
      }
    }, dependencies: [RouterOutlet, MatProgressBarModule, MatProgressBar, NgIf], styles: ["\n\n.loading-bar[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: 9999;\n}\n/*# sourceMappingURL=app.component.css.map */"] });
  }
};
(() => {

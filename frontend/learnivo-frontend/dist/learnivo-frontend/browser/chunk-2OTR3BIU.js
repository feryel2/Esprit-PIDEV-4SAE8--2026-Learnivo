...
var ApiService = class _ApiService {
  ...
  // ── Internships ────────────────────────────────────────
  listInternships() {
    return this.http.get(`${this.base}/internships`);
  }
  ...
  validateInternship(id) {
    return this.http.put(`${this.base}/internships/${id}/validate`, {});
  }
  deleteInternship(id) {
  ...
  // ── Applications ───────────────────────────────────────
  listApplications() {
    return this.http.get(`${this.base}/applications`);
  }
  createApplication(data) {
    return this.http.post(`${this.base}/applications`, data);
  }
  updateApplication(id, data) {
    return this.http.put(`${this.base}/applications/${id}`, data);
  }
  ...
  // ── Certificates ───────────────────────────────────────
  listCertificates() {
    return this.http.get(`${this.base}/certificates`);
  }
  createCertificate(data) {
    return this.http.post(`${this.base}/certificates`, data);
  }
  updateCertificate(id, data) {
    return this.http.put(`${this.base}/certificates/${id}`, data);
  }
  deleteCertificate(id) {
    return this.http.delete(`${this.base}/certificates/${id}`);
  }
  verifyCertificate(code) {
    return this.http.get(`${this.base}/certificates/verify/${code}`);
  }
  downloadCertificateUrl(id) {
  ...
  updateEvent(id, data) {
    return this.http.put(`${this.base}/events/${id}`, data);
  }
  deleteEvent(id) {
...
//# sourceMappingURL=chunk-2OTR3BIU.js.map

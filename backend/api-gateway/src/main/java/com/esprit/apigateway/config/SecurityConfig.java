    ...
    public SecurityWebFilterChain securedFilterChain(ServerHttpSecurity http, JwtAuthenticationWebFilter jwtAuthenticationWebFilter) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(HttpMethod.POST, "/api/courses/recommendations/ai").hasAnyRole("STUDENT", "TEACHER")
                        .pathMatchers(HttpMethod.POST, "/api/quizzes/*/evaluate").hasAnyRole("STUDENT", "TEACHER")
                        .pathMatchers(HttpMethod.POST, "/api/quizzes/*/hint").hasAnyRole("STUDENT", "TEACHER")
